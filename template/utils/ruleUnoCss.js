const behaviors = [
  ...
  [
    "input",
    { height: "30px", "padding-left": "0.5em", "padding-right": "0.5em" },
  ],
...
const layouts = [
  ...
  [
    /^gtc-(\d+)-(\d+)$/,
    ([, d1, d2]) => ({ "grid-template-columns": `${d1} ${d2}` }),
  ],
  [
    /^gtc-(\d+)-(\d+)-(\d+)$/,
  ...
  [
    /^gtr-(\d+)-(\d+)$/,
    ([, d1, d2]) => ({ "grid-template-rows": `${d1} ${d2}` }),
  ],
  [
    /^gtr-(\d+)-(\d+)-(\d+)$/,
    ([, d1, d2, d3]) => ({ "grid-template-rows": `${d1} ${d2} ${d3}` }),
  ],
  [
    /^gtr-(\d+)-(\d+)-(\d+)-(\d+)$/,
    ([, d1, d2, d3, d4]) => ({
...
const spacing = [
  ...
  [
    /^mx-(\d+)$/,
    ([, d]) => ({ "margin-left": `${d / 2}em`, "margin-right": `${d / 2}em` }),
  ],
  [
    /^my-(\d+)$/,
    ([, d]) => ({ "margin-left": `${d / 2}em`, "margin-right": `${d / 2}em` }),
